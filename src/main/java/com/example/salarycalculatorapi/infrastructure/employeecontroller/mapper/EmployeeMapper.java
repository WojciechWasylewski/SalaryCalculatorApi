package com.example.salarycalculatorapi.infrastructure.employeecontroller.mapper;

import com.example.salarycalculatorapi.domain.employee.model.Employee;
import com.example.salarycalculatorapi.infrastructure.employeecontroller.dto.request.PartiallyUpdateEmployeeRequestDto;
import com.example.salarycalculatorapi.infrastructure.employeecontroller.dto.response.PartiallyUpdateEmployeeResponseDto;
import com.example.salarycalculatorapi.infrastructure.employeecontroller.dto.request.UpdateEmployeeRequestDto;
import com.example.salarycalculatorapi.infrastructure.employeecontroller.dto.response.UpdateEmployeeResponseDto;
import com.example.salarycalculatorapi.infrastructure.employeecontroller.dto.response.DeleteEmployeeResponseDto;
import com.example.salarycalculatorapi.infrastructure.employeecontroller.dto.response.GetEmployeeResponseDto;
import com.example.salarycalculatorapi.infrastructure.employeecontroller.dto.request.PostEmployeeRequestDto;
import com.example.salarycalculatorapi.infrastructure.employeecontroller.dto.response.PostEmployeeResponseDto;
import com.example.salarycalculatorapi.infrastructure.employeecontroller.dto.response.EmployeeDto;
import com.example.salarycalculatorapi.infrastructure.employeecontroller.dto.response.GetAllEmployeeResponseDto;
